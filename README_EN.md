...
This is an open-source Feishu channel for Claude Code. It works exactly like the built-in Telegram channel: messages from Feishu are pushed into your Claude Code session in real time, and you reply through MCP tools.
